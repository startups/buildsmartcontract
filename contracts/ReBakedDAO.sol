...
contract ReBakedDAO is IReBakedDAO, Ownable, ReentrancyGuard {
     ...
     * @param projectId_ Id of the project
     * @param packageId_ Id of the project
     * @param collaborators_ address of the collaborators
     * @param observers_ address of the observers
     ...
     * @param packageId_ Id of the package
     * @param collaborator_ collaborator's address
     * @param shouldPayMgp_ Should pay MGP for the collaborator
    ...
    function removeCollaborator(
        ...
        emit RemovedCollaborator(projectId_, packageId_, collaborator_, shouldPayMgp_);
    }
    ...
    function selfRemove(bytes32 projectId_, bytes32 packageId_) external {
        ...
        emit SelfRemovedCollaborator(projectId_, packageId_, _msgSender())
    }
    ...
    function defendRemoval(bytes32 _projectId, bytes32 _packageId) external {
        ...
        emit DefendedRemoval(projectId_, packageId_, _msgSender())
    }
    ...
    function resolveDispute(
        ...
        emit ResolvedDispute(projectId_, packageId_, _collaborator, _isApproved)
    }
    ...
    function settleExpiredDispute(
        ...
        emit ResolvedDispute(projectId_, packageId_, _collaborator, false)
    }
     ...
     * @param projectId_ Id of the project
     * @param packageId_ Id of the package
     * @param collaborator_ Collaborator address
     */
